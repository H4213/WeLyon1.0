var Messages = (function() {
    ...
    var Login = {
        INVALID_CREDENTIALS: {value: 0, description: 'Não foi possível carregar a tela de autenticação.<br><b>Motivo: </b>Credenciais inválidas.', type: MessageType.ERROR},
        LOGIN_ERROR: {value: 1, description: 'Não foi possível efetuar o login.<br><b>Motivo: </b>%s', type: MessageType.ERROR}
    };
